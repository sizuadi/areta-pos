      ...
      <div className='toolbar' id='kt_toolbar'>
        <div id='kt_toolbar_container' className='container-fluid d-flex flex-stack'>
          <div data-kt-swapper='true' data-kt-swapper-mode='prepend' data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" className='page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0'>
            <h1 className='d-flex align-items-center text-dark fw-bolder fs-3 my-1 py-3'>Barang Keluar</h1>
            ...
            <div className="col-xl-3">
              <a href="/" className="card bg-primary hoverable card-xl-stretch mb-xl-8">
                <div className="card-body">
                  ...
                  <div className="fw-bold fs-6 text-white">Total Barang</div>
                </div>
              </a>
            </div>																	
            <div className="col-xl-3">
              <a href="/" className="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
                <div className="card-body">
                  ...
                  <div className="text-white fw-bolder fs-1 mb-2 mt-5">100</div>
                  <div className="fw-bold fs-6 text-white">Total Barang Masuk</div>
                </div>
              </a>
            </div>
            <div className="col-xl-3">
              <a href="/" className="card bg-warning hoverable card-xl-stretch mb-5 mb-xl-8">
                <div className="card-body">
                  ...
                  <div className="text-white fw-bolder fs-1 mb-2 mt-5">100</div>
                  <div className="fw-bold fs-5 text-white">Total Barang Keluar</div>
                </div>
              </a>
            </div>
            <div className="col-xl-3">
              <a href="/" className="card bg-danger hoverable card-xl-stretch mb-xl-8">
                <div className="card-body">
                  ...
                  <div className="text-white fw-bolder fs-1 mb-2 mt-5">100</div>
                  <div className="fw-bold fs-5 text-white">Total Barang Reject</div>
                </div>
              </a>
            </div>
          </div>
          <div className="card mb-5 mb-xl-8">
            <div className="card-header border-0 pt-5">
              ...
              <div className="card-toolbar">
                <Link to="/inventory/barang-keluar/create" replace={true} className="btn btn-primary">
                  Tambah Data
                </Link>
              </div>
            </div>
